...
readonly HAPROXY_SERVER_NAME="openapi-mcp"
...
start_mcp_server() {
    ...
    # mcp_server_cmd is the prebuilt stdio backend invocation. Split it preserving quoted segments.
    ...
    echo "Launching OpenAPI MCP via ${PROTOCOL_DISPLAY}"
